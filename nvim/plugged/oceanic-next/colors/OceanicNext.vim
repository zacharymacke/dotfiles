...
call <sid>hi('Special',                    s:base08, '',       '',          '')
call <sid>hi('SpecialChar',                s:base0F, '',       '',          '')
call <sid>hi('Statement',                  s:base0A, '',       '',          '')
...
call <sid>hi('javaScriptBraces',           s:base0C, '',       '',          '')
